...
async function seed(
  ...
  const revision: MemoryRevision = {
    ...
    semanticKey: `general_fact:test:${options.memoryId}`,
    status,
    canonicalContent,
    ...
    provenance: {
      ...
      candidateFingerprint: `fingerprint:${options.memoryId}`,
      producer: { kind: "system", id: "verified-retrieval-test" },
    ...
    producer: { kind: "system", id: "verified-retrieval-test" },
    sourceExperienceRefs: [],
    semanticFingerprint: `fingerprint:${options.memoryId}`,
